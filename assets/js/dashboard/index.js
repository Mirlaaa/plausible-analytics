...
export const statsBoxClass = "stats-item relative w-full mt-6 p-4 max-xs:mt-2 flex flex-col bg-white dark:bg-gray-825 shadow-xl rounded"
export const statsBoxClassPage = "relative w-full max-xs:mt-2  mt-6 p-4 flex flex-col bg-white dark:bg-gray-825 shadow-xl rounded"
